...
public class DlgDonut extends JDialog {
	...
	public DlgDonut() {
		...
		}
		{
			...
			lblInnerRadius.setForeground(Color.PINK);
		...
		{	
			...
			txtInnerRadius.setBackground(Color.PINK);
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) 
					{
						try
						{
							...
							if (newX < 0 || newY < 0 || newInnerRadius < 1 || newRadius < 1)
							{
								JOptionPane.showMessageDialog(null, "You have put the wrong value", "Error", JOptionPane.ERROR_MESSAGE);
							}
							else {
							Donut d = new Donut( new Point(newX, newY), newInnerRadius, newRadius, false, borderFill, innerFill);
							confirmation = true;
							dispose();
							}
						}
