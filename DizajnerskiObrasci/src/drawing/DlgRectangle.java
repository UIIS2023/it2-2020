...
public class DlgRectangle extends JDialog {
	...
	public DlgRectangle() {
		...
		}
		{
			...
			txtWidth.setBackground(Color.PINK);
		...
		}
		{
			...
			txtHeight.setBackground(Color.PINK);
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) 
					{
						try
						{
							...
							Rectangle r = new Rectangle( new Point(newX, newY), newHeight, newWidth, false, borderFill, innerFill);
							confirmation = true;
							dispose();
							}
						}
